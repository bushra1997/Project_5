...
const { CreateNewPlace,getAllPlaces,updatePlaceById,deletePlaceById,getPlaceById,getPlaceByType ,getPlaceByTypeImg,getAllPlacesImg,getAllPlacesByName} = require("./../controllers/place");
