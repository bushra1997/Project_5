...
.catch((err)=>{
    ...
    const update =()=>{
axios.put(`http://localhost:5000/places/${number}`,{
name,
description,
img,
city,
...
console.log(result.data);
    ...
    const Delete =()=>{
        axios.delete(`http://localhost:5000/places/${number}`,{
            name,
            description,
            img,
            city,
    ...
    return (
        <div className="main-div">
            ...
            <input type="text" placeholder="input number id" onChange={(e)=>{
            ...
            <input placeholder={availability} onChange={(e)=>{
             setAvailability(e.target.value)}}/>
            <lable>capacity</lable>
            <input placeholder={capacity} onChange={(e)=>{
